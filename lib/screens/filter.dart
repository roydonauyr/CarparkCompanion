...
class _filterState extends State<filter> {
  Map<String, Map<String, bool>> switches = {
    'car_park_type': {
    ...
    for (int i = 0; i < filters.length; i++) {
      ...
      for (int j = 0; j < value.length; j++) {
        ...
        for (int z = 0; z < filtered2.length; z++) {
          ...
          else if (key == "type_of_parking_system" && name == car.type_of_parking_system) {
            filtered1.add(car);
          }
          ...
          else if(name == "YES" && name != car.free_parking && car.free_parking != "NO"){
            filtered1.add(car);
          }
          }
          ...
          else if(name == "YES" && name != car.short_term_parking && car.short_term_parking != "NO"){
            filtered1.add(car);
          }
          }
        }
                ...
                onPressed: () {
                  ...
                  for (int i=0; i<switches.length; i++) {
                    ...
                    for (carparkDetail objects in filtered) {
                        ...
                        markersGenerator()
                            .generate_colored_markers(objects, context);
        ...
        body: Column(children: <Widget>[
          ...
          Row(
            ...
            children: [
              ...
              Switch(
                value: switches['type_of_parking_system']!['ELECTRONIC PARKING']!,
                onChanged: (value) {
                  setState(() {
                    switches['type_of_parking_system']!['ELECTRONIC PARKING'] = ! (switches['type_of_parking_system']!['ELECTRONIC PARKING']!);
                  });
                },
                activeColor: Colors.green,
              )
          ...
          Row(
            ...
            children: [
              ...
              Switch(
                ...
                onChanged: (value) {
                  setState(() {
                    switches['type_of_parking_system']!['COUPON PARKING'] = ! (switches['type_of_parking_system']!['COUPON PARKING']!);
                  });
                },
                activeColor: Colors.green,
              )
          ...
          Row(
            ...
            children: [
              ...
              Switch(
                ...
                onChanged: (value) {
                  setState(() {
                    switches['night_parking']!['YES'] = ! (switches['night_parking']!['YES']!);
                  });
                },
                activeColor: Colors.green,
              )
          ...
          Row(
            ...
            children: [
              ...
              Switch(
                ...
                onChanged: (value) {
                  setState(() {
                    switches['free_parking']!['YES'] = ! (switches['free_parking']!['YES']!);
                  });
                },
                activeColor: Colors.green,
              )
          ...
          Row(
            ...
            children: [
              ...
              Switch(
                ...
                onChanged: (value) {
                  setState(() {
                    switches['short_term_parking']!['YES'] = ! (switches['short_term_parking']!['YES']!);
                  });
                },
                activeColor: Colors.green,
              )
